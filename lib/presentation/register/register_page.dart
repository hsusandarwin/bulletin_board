                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: CustomTextField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return AppLocalizations.of(context)!.confirmPsw;
                          }
                          if (value != _pswcontroller.text.trim()) {
                          ...
                          try {
                            ...
                            if (context.mounted) {
                              if (e is FirebaseAuthException && e.code == 'email-already-in-use') {
                                showSnackBar(context, "This email is already registered", Colors.red);
                              } else {
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          if (authState.isSuccess) {
                            showSnackBar(
                              context,
                              AppLocalizations.of(context)!.successGoogleSignin,
                              Colors.green,
                            );
                    ...
                    TextButton(
                      ...
                      child: Text(
                        AppLocalizations.of(context)!.askLogin,
